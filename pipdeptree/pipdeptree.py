...
class ReqPackage(Package):
    ...
    def as_dict(self):
        return {'key': self.key,
                ...
                'required_version': self.version_spec}  # 增加了一个属性
...
# 通过pip获取安装的依赖包
# 返回类型：[<class 'pip._vendor.pkg_resources.DistInfoDistribution'>, ]
...
def main():
    ...
    # 谈到单例模式的实现，使用classmethod不是线程安全的(个人没有验证：https://www.cnblogs.com/huchong/p/8244279.html)
