...
void printWordVectors(const std::vector<std::string> args) {  // 打印词向量
  if (args.size() != 3) {
...
void printSentenceVectors(const std::vector<std::string> args) {  // 打印句向量
  if (args.size() != 3) {
...
void printNgrams(const std::vector<std::string> args) {  // ngrams向量
  if (args.size() != 4) {
...
void nn(const std::vector<std::string> args) {   // 打印top-k个相近的单词
  int32_t k;
  if (args.size() == 3) {
    k = 10;
  } else if (args.size() == 4) {
...
void analogies(const std::vector<std::string> args) {  // 类比任务
  int32_t k;
  if (args.size() == 3) {
    k = 10;
  } else if (args.size() == 4) {
